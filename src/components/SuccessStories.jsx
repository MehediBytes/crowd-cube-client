...
const SuccessStories = () => {
    return (
        <section className="bg-teal-400 text-base-100 p-5 rounded-xl mb-8">
            <div className="text-center">
                <h2 className="lg:text-3xl text-xl font-bold mb-5">Transforming Dreams into Reality</h2>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    {/* Success Story Card 1 */}
                    <div className="bg-teal-600 shadow-lg rounded-lg p-5 flex justify-between flex-grow items-center flex-col gap-3 transition-transform transform hover:scale-105">
