...
const SuccessStories = () => {
    return (
        <section className="bg-teal-400 text-white py-10 px-5 rounded-xl">
            <div className="container mx-auto text-center">
                <h2 className="lg:text-3xl text-xl font-bold mb-8">Transforming Dreams into Reality</h2>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                    {/* Success Story Card 1 */}
                    <div className="bg-teal-600 shadow-lg rounded-lg p-6 flex justify-center items-center flex-col gap-3">
